    ...
    >
      ...
      <span
        className={`block transition-all duration-500 ease-out ${
          isActive ? 'blur-sm opacity-20' : 'blur-0 opacity-100'
        }`}
      >
        {text}
      </span>
      ...
      {/* ELI5 Text Overlay */}
      <span
        className={`absolute inset-0 flex items-center ${justifyClass} transition-all duration-500 ease-out font-sans font-medium not-italic text-accent ${
          isActive
