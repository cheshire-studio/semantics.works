  ...
  return (
    <section className="px-6 md:px-12 py-32 md:py-48 animate-in fade-in duration-1000 min-h-screen bg-neutral-50">
      <div className="max-w-3xl mx-auto space-y-16">
        <div>
          <h1 className="text-[clamp(2.5rem,8vw,6rem)] font-light tracking-tighter italic mb-8 uppercase">
            Privacy
          </h1>
        ...
        <div className="space-y-12 text-sm font-light leading-relaxed opacity-80">
          <div className="space-y-4">
            <h2 className="text-lg font-normal uppercase tracking-widest">
            ...
            <h3 className="uppercase tracking-widest text-xs opacity-60">
            ...
            <p>
              ...
              Kontaktformular). Andere Daten werden automatisch oder nach Ihrer Einwilligung beim
          ...
          <div className="space-y-4">
            ...
            <p>
              Vercel ist eine Plattform zum Hosting von Websites und zur Bereitstellung von
              Cloud-Diensten. Die Datenverarbeitung erfolgt auf Grundlage von Art. 6 Abs. 1 lit. f
              DSGVO. Wir haben ein berechtigtes Interesse an einer möglichst zuverlässigen
              Darstellung unserer Website. Details finden Sie in der Datenschutzerklärung von
              Vercel:{' '}
              <a
            ...
            <p>
              ...
              <br />
              Zur Verbesserung der Benutzerfreundlichkeit und technischen Stabilität nutzen wir
              "Vercel Analytics". Dieser Dienst verarbeitet Daten anonym und setzt keine Cookies.
          ...
          <div className="space-y-4">
            ...
            <p>
              Unsere Website verwendet <strong>keine</strong> Cookies, die eine Einwilligung
              erfordern. Wir verzichten bewusst auf Tracking-Tools, die personenbezogene Daten
              speichern oder an Dritte weitergeben (wie z.B. Google Analytics).
            </p>
            <p>
              Technisch notwendige Cookies oder ähnliche Technologien, die für die Funktion der
              Website zwingend erforderlich sind, können unter Umständen eingesetzt werden (z.B. zur
              Sicherstellung der Sicherheit oder Lastverteilung). Für diese ist keine Einwilligung
              erforderlich.
            </p>
