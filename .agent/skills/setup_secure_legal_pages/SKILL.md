...
3.  **Harden** the components (SEO & Anti-Spam):
    ...
    -   **Anti-Spam**: Identify email addresses and phone numbers.
        -   *Recommendation*: Replace plain text with images (e.g., `/assets/contact_email.png`) to prevent scraping.
        -   *Alternative*: Use simple JS obfuscation if images are not available.
