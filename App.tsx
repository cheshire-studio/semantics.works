          ...
          <section className="px-6 md:px-12 py-32 md:py-48 animate-in fade-in duration-1000">
            <div className="grid grid-cols-1 md:grid-cols-12 gap-x-12 max-w-[1600px] mx-auto">
              <div className="md:col-span-12 mb-32">
                <h1 className="text-[clamp(3rem,10vw,10rem)] font-light tracking-tighter italic mb-12 uppercase">Works</h1>
          ...
          <section className="px-6 md:px-12 py-32 md:py-48 bg-white min-h-screen animate-in fade-in duration-1000">
            <div className="max-w-7xl mx-auto">
              <div className="mb-48 max-w-4xl">
                ...
                <p className="text-2xl md:text-3xl font-light opacity-80 leading-snug italic">
                  Making data make sense. We bridge the gap between technical complexity and business logic by building the semantic architectures that power modern, agent-ready enterprises.
                </p>
              </div>
              ...
              <div className="flex flex-col md:flex-row gap-24 items-start">
                ...
                <div className="md:w-[55%] space-y-20">
                  <div>
                    ...
                    <p className="text-xl md:text-2xl mt-6 opacity-40 font-light tracking-tight italic">Make Data Make Sense</p>
                  </div>
                  <div className="space-y-10 max-w-xl">
                    <p className="text-xl font-light opacity-80 leading-relaxed italic">
                      SEMANTICS.WORKS is a specialist consultancy focused on the architecture of data platforms for agile SMEs and high-growth B2C enterprises.
                    </p>
              ...
              <div className="py-32 space-y-24">
                <div className="flex flex-col md:flex-row justify-between items-start gap-12">
                  <div className="md:w-1/2">
                    <span className="text-[10px] uppercase tracking-[0.5em] opacity-30 italic block mb-8">— The Core Thesis</span>
                  ...
                  <div className="md:w-1/2 max-w-xl">
                    <p className="text-xl font-light opacity-60 leading-relaxed italic">
                      In the era of Generative AI, the "Semantic Gap" is the biggest bottleneck. If your LLMs don't understand your business logic, they will hallucinate. We build the definition layer that ensures your data "makes sense" to both your team and your agents.
                    </p>
                  </div>
                </div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-12 pt-16 border-t border-black/5">
                  <div className="space-y-6">
                    <h4 className="text-[10px] uppercase tracking-widest font-medium opacity-40">Knowledge Hub</h4>
                    <p className="text-sm font-light opacity-60 leading-relaxed">Centralized definitions for metrics, entities, and relationships. No more "definitions in spreadsheets".</p>
                  </div>
                  <div className="space-y-6">
                    <h4 className="text-[10px] uppercase tracking-widest font-medium opacity-40">AI Readiness</h4>
                    <p className="text-sm font-light opacity-60 leading-relaxed">Agentic workflows require high-fidelity data context. We architect the schemas that LLMs can actually reason with.</p>
                  </div>
                  <div className="space-y-6">
                    <h4 className="text-[10px] uppercase tracking-widest font-medium opacity-40">Human Clarity</h4>
                    <p className="text-sm font-light opacity-60 leading-relaxed">Removing the engineering bottleneck. Business users get direct access to self-serve data they can trust.</p>
                  </div>
                </div>
              </div>
            </div>
          ...
          <section className="min-h-screen flex items-center justify-center relative bg-black text-white overflow-hidden">
            ...
            <div className="relative z-10 text-center space-y-16 px-6">
              <div className="space-y-4 flex flex-col items-center">
                <span className="text-[10px] md:text-xs tracking-[0.6em] font-light opacity-50 animate-pulse uppercase">Make Data Make Sense</span>
              ...
              <div className="max-w-2xl mx-auto space-y-12">
                ...
                <div className="flex flex-col md:flex-row items-center justify-center gap-8">
                  ...
                  >
                    <span className="relative z-10 text-[10px] tracking-[0.4em] font-light">SELECTED WORKS</span>
                    <div className="absolute inset-0 bg-white translate-y-full group-hover:translate-y-0 transition-transform duration-500 ease-out"></div>
                    <span className="absolute inset-0 z-20 flex items-center justify-center text-black opacity-0 group-hover:opacity-100 transition-opacity text-[10px] tracking-[0.4em] font-light">SELECTED WORKS</span>
                  </button>
                </div>
              </div>
            </div>
            ...
            <div className="absolute bottom-12 right-12 hidden md:block">
              <p className="text-[9px] tracking-[0.4em] opacity-30 uppercase">©2026 SEMANTICS.WORKS</p>
            </div>
          </section>
        );
    }
        ...
        <footer className="px-6 md:px-12 py-32 border-t border-black/5 bg-neutral-50 text-black">
          <div className="flex flex-col md:flex-row justify-between items-start md:items-end gap-16 max-w-[1400px] mx-auto">
            ...
            <div className="space-y-8 text-right hidden md:block w-full md:w-1/2">
              ...
              <div className="text-[9px] tracking-[0.4em] uppercase opacity-30">
                Data Platform Strategy — Semantic Architecture <br /> Data Engineering — Consumer Intelligence
              </div>
              <div className="flex justify-end gap-8 text-[9px] tracking-[0.2em] uppercase opacity-40">
                <button onClick={() => setCurrentPage(Page.Imprint)} className="hover:opacity-100 transition-opacity">Imprint</button>
                <button onClick={() => setCurrentPage(Page.Privacy)} className="hover:opacity-100 transition-opacity">Privacy</button>
              </div>
            </div>
          </div>
        </footer>
